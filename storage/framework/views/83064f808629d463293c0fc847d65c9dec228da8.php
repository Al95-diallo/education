...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('Gestion des élèves'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('Tableau de bord'); ?></a>
                <a href="#"> <?php echo app('translator')->get('Information sur les élèves'); ?></a>
                <a href="#"><?php echo app('translator')->get('Liste des élèves'); ?></a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div class="main-title mt_0_sm mt_0_md">
                        <h3 class="mb-30  "><?php echo app('translator')->get('Sélectionner des critères'); ?></h3>
                    </div>
                </div>
                ...
                <?php if(in_array(65, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                 <div class="col-lg-4 text-md-right text-left col-md-6 mb-30-lg col-sm-6 text_sm_right">
                    <a href="<?php echo e(route('student_admission')); ?>" class="primary-btn small fix-gr-bg">
                        ...
                        <?php echo app('translator')->get('Ajouter un élèves'); ?>
                    </a>
                </div>
            <?php endif; ?>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect sm2_mb_20 md_mb_20">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('academic_year') ? ' is-invalid' : ''); ?>" name="academic_year" id="academic_year">
                                    <option data-display="<?php echo app('translator')->get('L\'année scolaire'); ?> *" value=""><?php echo app('translator')->get('L\'année scolaire'); ?> *</option>
                        ...
                        <div class="col-lg-3 sm_mb_20 sm2_mb_20 md_mb_20" id="class-div">
                            <select class="niceSelect w-100 bb form-control <?php echo e($errors->has('class') ? ' is-invalid' : ''); ?>" id="classSelectStudent" name="class">
                                <option data-display="<?php echo app('translator')->get('Selectionnez la classe'); ?> *" value=""><?php echo app('translator')->get('Selectionnez la classe'); ?></option>
                        ...
                        <div class="col-lg-2 col-md-3" id="sectionStudentDiv">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>" id="sectionSelectStudent" name="section">
                                    <option data-display="<?php echo app('translator')->get('le niveaux'); ?>" value=""><?php echo app('translator')->get('le niveaux'); ?></option>
                                </select>
                        ...
                        <div class="col-lg-2">
                            <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                                ...
                                <label><?php echo app('translator')->get('Rechercher par nom'); ?></label>
                                <span class="focus-border"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                                ...
                                <label><?php echo app('translator')->get('Rechercher par matricule'); ?></label>
                                <span class="focus-border"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mt-20 text-right">
                            <button type="submit" class="primary-btn small fix-gr-bg" id="btnsubmit">
                                ...
                                <?php echo app('translator')->get('Rechercher'); ?>
                            </button>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('Liste de élèves'); ?> (<?php echo e(@$students ? @$students->count() : 0); ?>)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row  ">
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('Matricule'); ?></th>
                                        <th><?php echo app('translator')->get('Nom_élèves'); ?></th>
                                        <th><?php echo app('translator')->get('classes'); ?></th>
                                        <th><?php echo app('translator')->get('Nom du père'); ?></th>
                                        <th><?php echo app('translator')->get('date de naissance'); ?></th>
                                        <th><?php echo app('translator')->get('sexe'); ?></th>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="<?php echo e(route('student_view', [$student->id])); ?>"><?php echo app('translator')->get('voir'); ?></a>

                                                

                                                <?php if(in_array(66, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                    <a class="dropdown-item" href="<?php echo e(route('student_edit', [$student->id])); ?>"><?php echo app('translator')->get('modifier'); ?></a>
                                                <?php endif; ?>
                                                 ...
                                                 <span  data-toggle="tooltip" title="Disabled For Demo "> 
                                                    <a  class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteStudentModal" data-id=""  ><?php echo app('translator')->get('Désactiver'); ?></a>
                                               
                                                     </span>
                                                     
                                                 <?php else: ?>
                                                 <a onclick="deleteId(<?php echo e($student->id); ?>);" class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteStudentModal" data-id="<?php echo e($student->id); ?>"  ><?php echo app('translator')->get('Désactiver'); ?></a>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo app('translator')->get('Désactiver un élèves'); ?></h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <h4><?php echo app('translator')->get('este-vous sur de vouloir Désactiver cet élève'); ?></h4>
                    </div>
                    ...
                    <input type="hidden" name="id" value="<?php echo e(@$student->id); ?>" id="student_delete_i">  
                            <button class="primary-btn fix-gr-bg" type="submit"><?php echo app('translator')->get('Désactiver'); ?></button>
                        <?php echo e(Form::close()); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/studentInformation/student_details.blade.php ENDPATH**/ ?>