...
<div class="container-fluid p-0">
    ...
    <?php if(in_array(553, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 || Auth::user()->role_id == 2 ): ?>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a data-modal-size="modal-lg" title="View Leave Details" class="dropdown-item modalLink" href="<?php echo e(url('view-leave-details-apply', $apply_leave->id)); ?>"><?php echo app('translator')->get('lang.view'); ?></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/apply_leave.blade.php ENDPATH**/ ?>