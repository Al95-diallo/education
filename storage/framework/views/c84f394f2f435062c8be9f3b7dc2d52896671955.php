...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.staffs_payroll'); ?></h1>
            <div class="bc-pages">
        ...
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('lang.generate_payroll'); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="white-box">
                        <div class="single-meta mt-20">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-6">
                                    <div class="name">
                                        <?php echo app('translator')->get('lang.staff_no'); ?>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6">
                                    <div class="value text-left">
                                ...
                                <div class="col-lg-1 col-md-3">
                                    <div class="value text-left">
                                        <?php echo app('translator')->get('lang.month'); ?>
                                    </div>
                                </div>
    ...
    <div class="container-fluid p-0">
        <div class="row">
                            ...
                            <tr id="row0">
                                <td width="80%" class="pr-30">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="earningsType0"><?php echo app('translator')->get('lang.type'); ?></label>
                                ...
                                <td width="20%">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="earningsValue0"><?php echo app('translator')->get('lang.value'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
            ...
            <div class="col-lg-4 no-gutters">
                <div class="d-flex justify-content-between mb-20">
                    <div class="main-title">
                        <h3><?php echo app('translator')->get('lang.deductions'); ?></h3>
                    </div>
                            ...
                            <tr id="DeductionRow0">
                                <td width="80%" class="pr-30">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="deductionstype0"><?php echo app('translator')->get('lang.type'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                                <td width="20%">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="deductionsValue0"><?php echo app('translator')->get('lang.value'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="col-lg-4 no-gutters">
                <div class="d-flex justify-content-between mb-20">
                    <div class="main-title">
                        <h3><?php echo app('translator')->get('lang.payroll_summary'); ?></h3>
                    </div>

                    <div>
                        <button type="button" class="primary-btn small fix-gr-bg" onclick="calculateSalary()">
                            <?php echo app('translator')->get('lang.calculate'); ?>
                        </button>
                    </div>
                </div>
                            ...
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-10">
                                        ...
                                        <label for="basicSalary"><?php echo app('translator')->get('lang.basic_salary'); ?> (<?php echo e($currency); ?>)</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="total_earnings"><?php echo app('translator')->get('lang.earning'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="total_deduction"><?php echo app('translator')->get('lang.deduction'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="gross_salary"><?php echo app('translator')->get('lang.gross_salary'); ?>  (<?php echo e($currency); ?>)</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30">
                                        ...
                                        <label for="tax"><?php echo app('translator')->get('lang.tax'); ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </td>
                            </tr>
                            <tr class="d-block">
                                <td width="100%" class="pr-30 d-block">
                                    <div class="input-effect mt-30 mb-30">
                                        ...
                                        <label for="net_salary"><?php echo app('translator')->get('lang.net_salary'); ?> (<?php echo e($currency); ?>)</label>
                                        <span class="focus-border"></span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/payroll/generatePayroll.blade.php ENDPATH**/ ?>