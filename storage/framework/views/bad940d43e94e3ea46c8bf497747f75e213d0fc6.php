...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.class_exam_time_setup'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.academics'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.class_exam_time_setup'); ?></a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row  ">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="niceSelect w-100 bb form-control<?php echo e(@$errors->has('time_type') ? ' is-invalid' : ''); ?>" name="time_type">
                                            <option data-display=" <?php echo app('translator')->get('lang.time_type'); ?> *" value=""><?php echo app('translator')->get('lang.time_type'); ?> *</option>
                                                <option value="class" <?php echo e(isset($class_time)? ($class_time->type == 'class'? 'selected':''):''); ?>><?php echo app('translator')->get('lang.class_time'); ?></option>
                                                <option value="exam" <?php echo e(isset($class_time)? ($class_time->type == 'exam'? 'selected':''):''); ?>><?php echo app('translator')->get('lang.exam_time'); ?></option>
                                        </select>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.class'); ?>/<?php echo app('translator')->get('lang.exam'); ?> <?php echo app('translator')->get('lang.period'); ?> <span>*</span></label>
                            ...
                            <thead>
                               <?php if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('lang.class'); ?>/<?php echo app('translator')->get('lang.exam'); ?> <?php echo app('translator')->get('lang.period'); ?></th>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(url('class-time/'.$class_time->id.'/edit')); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/academics/class_time.blade.php ENDPATH**/ ?>