...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('Gestion de personnels'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('tableau de bord'); ?></a>
                <a href="<?php echo e(url('staff-directory')); ?>"><?php echo app('translator')->get(' Ressource humaine'); ?></a>
                <a href="#"><?php echo app('translator')->get('Ajouter un nouveau personnel'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-8 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('Ajouter un nouveau personnel'); ?> </h3>
                </div>
            </div>
            <div class="col-lg-4 text-md-right text-left col-md-6 mb-30-lg">
                <a href="<?php echo e(route('staff_directory')); ?>" class="primary-btn small fix-gr-bg">
                    <?php echo app('translator')->get('Liste de personnel'); ?>
                </a>
            </div>
        </div>
        ...
        <div class="row">
              ...
              <div class="white-box">
                <div class="">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h4><?php echo app('translator')->get('Informations de base'); ?></h4>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-20">
                    ...
                    <div class="row mb-30">
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <label><?php echo app('translator')->get('Numéro Du Personnel '); ?> <span>*</span> </label>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('role_id') ? ' is-invalid' : ''); ?>" name="role_id" id="role_id">
                                    ...
                                    <option data-display="Role *" value=""><?php echo app('translator')->get('Selectionnez'); ?></option>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('department_id') ? ' is-invalid' : ''); ?>" name="department_id" id="department_id">
                                    <option data-display="Department *" value=""><?php echo app('translator')->get('selectionnez'); ?> </option>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('designation_id') ? ' is-invalid' : ''); ?>" name="designation_id" id="designation_id">
                                    <option data-display="Designations *" value=""><?php echo app('translator')->get('Selectionnez'); ?> </option>
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <span class="focus-border"></span>
                                <label><?php echo app('translator')->get('Prénom'); ?> <span>*</span> </label>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <span class="focus-border"></span>
                                <label><?php echo app('translator')->get('Nom du père'); ?></label>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                ...
                                <span class="focus-border"></span>
                                <label><?php echo app('translator')->get('nom de la mère'); ?></label>
                    ...
                    <div class="row mb-30">
                       <div class="col-lg-3">
                        <div class="input-effect">
                            ...
                            <span class="focus-border"></span>
                            <label><?php echo app('translator')->get('email'); ?> <span>*</span> </label>
                    ...
                    <div class="col-lg-3">
                        <div class="input-effect">
                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('gender_id') ? ' is-invalid' : ''); ?>" name="gender_id">
                                <option data-display="Sexe *" value=""><?php echo app('translator')->get('sexe'); ?> *</option>
                        ...
                        <div class="no-gutters input-right-icon">
                            <div class="col">
                                <div class="input-effect">
                                    ...
                                    <span class="focus-border"></span>
                                    <label><?php echo app('translator')->get('date_naissance'); ?></label>
                        ...
                        <div class="no-gutters input-right-icon">
                            <div class="col">
                                <div class="input-effect">
                                    ...
                                    <span class="focus-border"></span>
                                    <label><?php echo app('translator')->get('Date D\'inscription'); ?> <span>*</span> </label>
                ...
                <div class="row mb-20">
                 <div class="col-lg-3">
                    <div class="input-effect">
                        ...
                        <span class="focus-border"></span>
                        <label><?php echo app('translator')->get('téléphone'); ?> <span>*</span> </label>
                ...
                <div class="col-lg-3">
                    <div class="input-effect">
                        <select class="niceSelect w-100 bb form-control" name="marital_status">
                            <option data-display="<?php echo app('translator')->get('état civil'); ?>" value=""><?php echo app('translator')->get('état civil'); ?></option>
                            
                            <option <?php echo e(old('marital_status') == 'married'? 'selected': ''); ?> value="married"><?php echo app('translator')->get('Marié'); ?></option>
                            <option <?php echo e(old('marital_status') == 'unmarried'? 'selected': ''); ?> value="unmarried"><?php echo app('translator')->get('Célibataire'); ?></option>
                ...
                <div class="col-lg-3">
                    <div class="input-effect">
                        ...
                        <span class="focus-border"></span>
                        <label><?php echo app('translator')->get('Numéro au cas d\'urgence '); ?></label>
                ...
                <div class="col-lg-3">
                    <div class="input-effect">
                        ...
                        <span class="focus-border"></span>
                        <label><?php echo app('translator')->get('Permis de conduire'); ?> </label>
                    ...
                    <div class="row no-gutters input-right-icon">
                        ...
                        <div class="col-auto">
                            <button class="primary-btn-small-input" type="button">
                                <label class="primary-btn small fix-gr-bg" for="staff_photo"><?php echo app('translator')->get('feuilleter'); ?></label>
            ...
            <div class="row mb-30">
                <div class="col-lg-6">
                    <div class="input-effect">
                        ...
                        <label><?php echo app('translator')->get('Adresse actuelle'); ?> <span>*</span> </label>
                ...
                <div class="col-lg-6">
                    <div class="input-effect">
                        ...
                        <label><?php echo app('translator')->get('adresse permanent'); ?> <span></span> </label>
                        <span class="focus-border textarea"></span>
            ...
            <div class="row md-20">
                <div class="col-lg-6">
                    <div class="input-effect">
                        ...
                        <label><?php echo app('translator')->get('qualifications'); ?> </label>
                        <span class="focus-border textarea"></span>
                ...
                <div class="col-lg-6">
                    <div class="input-effect">
                        ...
                        <label><?php echo app('translator')->get('expérience'); ?> </label>
                        <span class="focus-border textarea"></span>
            ...
            <div class="row mt-40">
                <div class="col-lg-12">
                    <div class="main-title">
                        <h4><?php echo app('translator')->get('Détails de la paie'); ?></h4>
                    </div>
                </div>
            </div>
            <div class="row mb-30">
            ...
            <div class="col-lg-3">
               <div class="input-effect">
                   ...
                   <label><?php echo app('translator')->get('salaire de base'); ?> *</label>
                   <span class="focus-border"></span>
        ...
        <div class="col-lg-3">
            <div class="input-effect">
                <select class="niceSelect w-100 bb form-control" name="contract_type">
                    <option data-display="<?php echo app('translator')->get('lang.contract_type'); ?>" value=""> <?php echo app('translator')->get('type de contrat'); ?></option>
                    <option value="permanent"><?php echo app('translator')->get('permanent'); ?> </option>
        ...
        <div class="col-lg-3">
           <div class="input-effect">
            ...
            <label><?php echo app('translator')->get('emplacement'); ?></label>
            <span class="focus-border"></span>
...
<div class="row mt-40">
    <div class="col-lg-12">
        <div class="main-title">
            <h4><?php echo app('translator')->get('Informations sur la banque'); ?></h4>
        </div>
    </div>
</div>
<div class="row mb-30">
...
<div class="row mb-20">
    <div class="col-lg-3">
       <div class="input-effect">
        ...
        <label><?php echo app('translator')->get('Nom du compte bancaire'); ?></label>
        <span class="focus-border"></span>
...
<div class="col-lg-3">
   <div class="input-effect">
    ...
    <label><?php echo app('translator')->get('Numéro du compte'); ?></label>
    <span class="focus-border"></span>
...
<div class="col-lg-3">
   <div class="input-effect">
    ...
    <label><?php echo app('translator')->get('Nom de la banque'); ?></label>
    <span class="focus-border"></span>
...
<div class="col-lg-3">
   <div class="input-effect">
    ...
    <label><?php echo app('translator')->get('nom de la filiale'); ?></label>
    <span class="focus-border"></span>
...
<div class="row mt-40">
    <div class="col-lg-12">
        <div class="main-title">
            <h4><?php echo app('translator')->get('Liens sociaux Détails'); ?></h4>
        </div>
    </div>
</div>
<div class="row mb-30">
...
<div class="row mb-20">
    <div class="col-lg-3">
       <div class="input-effect">
        ...
        <label><?php echo app('translator')->get('l\'adresse url de  facebook'); ?></label>
        <span class="focus-border"></span>
...
<div class="col-lg-3">
   <div class="input-effect">
    ...
    <label><?php echo app('translator')->get('url de twitter'); ?></label>
    <span class="focus-border"></span>
...
<div class="col-lg-3">
   <div class="input-effect">
    ...
    <label><?php echo app('translator')->get('url de linkedin'); ?></label>
    <span class="focus-border"></span>
...
<div class="col-lg-3">
   <div class="input-effect">
    ...
    <label><?php echo app('translator')->get('url de instragram'); ?></label>
    <span class="focus-border"></span>
...
<div class="row mt-40">
    <div class="col-lg-12">
        <div class="main-title">
            <h4><?php echo app('translator')->get('Informations sur le document'); ?></h4>
        </div>
    </div>
</div>
<div class="row mb-30">
...
<div class="row mb-20">
   <div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderResume" placeholder="<?php echo e(isset($editData->resume) && $editData->resume != ""? showPicName($editData->resume):'cv'); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
        <div class="col-auto">
            <button class="primary-btn-small-input" type="button">
                <label class="primary-btn small fix-gr-bg" for="resume"><?php echo app('translator')->get('feuilleter'); ?></label>
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderJoiningLetter" placeholder="<?php echo e(isset($editData->joining_letter) && $editData->joining_letter != ""? showPicName($editData->joining_letter):'lettre de motivation'); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
        <div class="col-auto">
            <button class="primary-btn-small-input" type="button">
                <label class="primary-btn small fix-gr-bg" for="joining_letter"><?php echo app('translator')->get('feuilleter'); ?></label>
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderOthersDocument" placeholder="<?php echo e(isset($editData->other_document) && $editData->other_document != ""? showPicName($editData->other_document):'Autre documents'); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
        <div class="col-auto">
            <button class="primary-btn-small-input" type="button">
                <label class="primary-btn small fix-gr-bg" for="other_document"><?php echo app('translator')->get('feuilleter'); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/addStaff.blade.php ENDPATH**/ ?>