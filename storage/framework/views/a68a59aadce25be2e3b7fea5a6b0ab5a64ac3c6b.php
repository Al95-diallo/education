                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-6 mt-30-md col-md-6">
                                    <select class="niceSelect w-100 bb form-control <?php echo e($errors->has('class') ? ' is-invalid' : ''); ?>" id="select_class" name="class">
                                        <option data-display="<?php echo app('translator')->get('sélectionnez la classe'); ?> *" value=""><?php echo app('translator')->get('sélectionnez la classe'); ?> *</option>
                                ...
                                <div class="col-lg-6 mt-30-md col-md-6" id="select_section_div">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>" id="select_section" name="section">
                                        <option data-display="<?php echo app('translator')->get('Sélectionnez le niveau actuelle'); ?>" value=""><?php echo app('translator')->get('Sélectionnez le niveau actuelle'); ?></option>
                                    </select>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/studentInformation/login_info.blade.php ENDPATH**/ ?>