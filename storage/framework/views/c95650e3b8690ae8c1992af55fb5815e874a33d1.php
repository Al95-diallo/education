...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('Gestion de matières'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('Tableau de bord'); ?></a>
                <a href="#"><?php echo app('translator')->get('Académique'); ?></a>
                <a href="#"><?php echo app('translator')->get('Ajouter une matière'); ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12 text-right col-md-12 mb-20">
                <a href="<?php echo e(url('subject')); ?>" class="primary-btn small fix-gr-bg">
                    <span class="ti-plus pr-2"></span>
                    <?php echo app('translator')->get('Ajouter une matière'); ?>
                </a>
            </div>
        </div>
        <?php endif; ?>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(isset($subject)): ?>
                                    <?php echo app('translator')->get('Modifier une matière'); ?>
                                <?php else: ?>
                                    <?php echo app('translator')->get('Ajouter une matière'); ?>
                                <?php endif; ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('Nom_matière'); ?> <span>*</span></label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex radio-btn-flex">
                                            ...
                                            <div class="mr-30">
                                                ...
                                                <label for="relationFather"><?php echo app('translator')->get('Théorie'); ?></label>
                                            </div>
                                            <div class="mr-30">
                                                ...
                                                <label for="relationMother"><?php echo app('translator')->get('Pratique'); ?></label>
                                            </div>
                                            <?php else: ?>
                                            <div class="mr-30">
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('Code_matière'); ?> <span>*</span></label>
                                            <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('Liste des matières'); ?></h3>
                        </div>
                    </div>
                </div>
                            ...
                            <thead>
                               <?php if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th> <?php echo app('translator')->get('type_matières'); ?></th>
                                    <th><?php echo app('translator')->get('Code_matières'); ?></th>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                 <?php if(in_array(259, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('subject_edit', [@$subject->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                               <?php endif; ?>
                                                <?php if(in_array(260, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('Supprimer une matière'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/academics/subject.blade.php ENDPATH**/ ?>