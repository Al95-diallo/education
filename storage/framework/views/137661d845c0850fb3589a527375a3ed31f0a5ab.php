                ...
                <?php if(@in_array(1, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    ...
                    <li>
                        ...
                        <?php endif; ?>
                            ...
                            <?php echo app('translator')->get('Tableau de bord'); ?>
                        </a>
                    </li>
                <?php endif; ?>
            <?php endif; ?>
                ...
                <?php if(@in_array(11, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuAdmin" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('Section Administrateur'); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuAdmin">
                            <?php if(@in_array(12, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('admission_query')); ?>"><?php echo app('translator')->get('Requete d\'admission'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(16, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('visitor')); ?>"><?php echo app('translator')->get('Gérer le visite'); ?> </a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(21, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('complaint')); ?>"><?php echo app('translator')->get('Gérer le plaintes'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(27, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('postal-receive')); ?>"><?php echo app('translator')->get('Réception postale'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(32, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('postal-dispatch')); ?>"><?php echo app('translator')->get('envoi postale'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(36, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('phone-call')); ?>"><?php echo app('translator')->get('Journale d\'appels'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(41, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('setup-admin')); ?>"><?php echo app('translator')->get('Configuration de l\Administrateur'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(49, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('student-certificate')); ?>"><?php echo app('translator')->get('Certificats des élèves'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(53, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('generate_certificate')); ?>"><?php echo app('translator')->get('Générer un certificats'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(45, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('student-id-card')); ?>"><?php echo app('translator')->get('Gérer les carte scolaire'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(57, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('generate_id_card')); ?>"><?php echo app('translator')->get('Générer une carte scolaire'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if(@in_array(61, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuStudent" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('Gestion des élèves'); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuStudent">
                            ...
                            <?php if(@in_array(71, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_category')); ?>"> <?php echo app('translator')->get('Catégorie des élèves'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(62, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                            <li>
                                <a href="<?php echo e(route('student_admission')); ?>"><?php echo app('translator')->get('Ajouter'); ?> <?php echo app('translator')->get('un élèves'); ?></a>
                            </li>
                            <?php endif; ?>
                            
                            <?php if(@in_array(64, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_list')); ?>"> <?php echo app('translator')->get('Liste de élèves'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(70, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_attendance_report')); ?>"> <?php echo app('translator')->get('Rapport de présence de élèves'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(535, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                ...
                                <li>
                                    <a href="<?php echo e(url('subject-attendance-report')); ?>"> <?php echo app('translator')->get('Rapport de présence des élèves'); ?> </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(76, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_group')); ?>"><?php echo app('translator')->get('Groupe des élèves'); ?></a>
                                </li>
                            <?php endif; ?>

                            <?php if(@in_array(81, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_promote')); ?>"><?php echo app('translator')->get('promouvoir des élèves'); ?></a>
                                </li>
                            <?php endif; ?>

                            <?php if(@in_array(83, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('disabled_student')); ?>"><?php echo app('translator')->get('élèves handicapés'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if(@in_array(245, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuAcademic" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('Gestion Académique'); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuAcademic">
                            ...
                            <?php if(@in_array(265, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('section')); ?>"> <?php echo app('translator')->get('Niveaux'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(261, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('class')); ?>"> <?php echo app('translator')->get('Classes'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(257, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('subject')); ?>"> <?php echo app('translator')->get('matières'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(269, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('class-room')); ?>"> <?php echo app('translator')->get('Salle de classe'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(253, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('assign-class-teacher')); ?>"> <?php echo app('translator')->get('Affectation des Enseignants à une classe'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(250, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('assign_subject')); ?>"> <?php echo app('translator')->get('Affectation des matières'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(246, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('class_routine_new')); ?>"> <?php echo app('translator')->get('Emplois du temps'); ?></a>
                ...
                <?php if(@in_array(188, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        ...
                        class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('Demande de congé'); ?>
                        </a>
                        ...
                        <?php if(@in_array(203, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('leave-type')); ?>"> <?php echo app('translator')->get('Type de congé'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(199, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('leave-define')); ?>"> <?php echo app('translator')->get('Laisser définir'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(189, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('approve-leave')); ?>"><?php echo app('translator')->get('Approuver la demande de congé'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(196, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('pending-leave')); ?>"><?php echo app('translator')->get('Congé en attente'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(193, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('apply-leave')); ?>"><?php echo app('translator')->get('Appliquer congé'); ?></a>
                                </li>
                            <?php endif; ?>
                ...
                <?php if(@in_array(277, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    ...
                    <li>
                        <a href="#subMenuHomework" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('Devoirs'); ?>
                        </a>
                ...
                <?php if(@in_array(286, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuCommunicate" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('communiquer'); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuCommunicate">
                            <?php if(@in_array(287, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('notice-list')); ?>"><?php echo app('translator')->get('tableau d\'affichage'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(291, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('send-email-sms-view')); ?>"><?php echo app('translator')->get('envoyer un e-mail/sms'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(293, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('email-sms-log')); ?>"><?php echo app('translator')->get('journal des e-mail/sms'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(294, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('event')); ?>"><?php echo app('translator')->get('évenement'); ?></a>
                                </li>
                            <?php endif; ?>
                            <li>
                ...
                <?php if(@in_array(298, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenulibrary" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('Bibliothèque'); ?>
                        </a>
                        ...
                        <?php if(@in_array(304, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('book-category-list')); ?>"> <?php echo app('translator')->get('Catégorie de livres'); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if(@in_array(299, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('add-book')); ?>"> <?php echo app('translator')->get('Ajouter un livre'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(301, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('book-list')); ?>"> <?php echo app('translator')->get('liste de livre'); ?></a>
                                </li>
                            <?php endif; ?>
                ...
                <?php if(@in_array(315, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuInventory" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('inventaire'); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuInventory">
                            <?php if(@in_array(316, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-category')); ?>"> <?php echo app('translator')->get('Catégorie d\'article'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(320, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-list')); ?>"> <?php echo app('translator')->get('liste des articles'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(324, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-store')); ?>"> <?php echo app('translator')->get('Magasin d\'article'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(328, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('suppliers')); ?>"> <?php echo app('translator')->get('Fournisseur'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(332, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-receive')); ?>"> <?php echo app('translator')->get('Article reçu'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(334, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-receive-list')); ?>"> <?php echo app('translator')->get('liste de réception d\'articles '); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(339, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-sell-list')); ?>"> <?php echo app('translator')->get('Article vendu'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(345, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('item-issue')); ?>"> <?php echo app('translator')->get('Point de problème'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if(@in_array(348, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                    <li>
                        <a href="#subMenuTransport" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            ...
                            <?php echo app('translator')->get('transport'); ?>
                        </a>
                        <ul class="collapse list-unstyled" id="subMenuTransport">
                            <?php if(@in_array(349, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('transport-route')); ?>"> <?php echo app('translator')->get('Itinéraire de transport'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(353, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('vehicle')); ?>"> <?php echo app('translator')->get('véhicule'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(357, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(url('assign-vehicle')); ?>"> <?php echo app('translator')->get('Attribuer un véhicule'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(@in_array(361, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_transport_report')); ?>"> <?php echo app('translator')->get('rapport sur les transport des élèves'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="subMenuDormitory">
                            ...
                            <?php if(@in_array(375, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                <li>
                                    <a href="<?php echo e(route('student_dormitory_report')); ?>"> <?php echo app('translator')->get('Rapport sur les transport des élèves'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
...
<?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/partials/sidebar.blade.php ENDPATH**/ ?>