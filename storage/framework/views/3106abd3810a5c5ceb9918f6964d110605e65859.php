...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('gestion de frais'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('tableau de bord'); ?></a>
                <a href="#"><?php echo app('translator')->get('collection frais'); ?></a>
                <a href="#"><?php echo app('translator')->get('gestion de frais'); ?></a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('fees_type') ? ' is-invalid' : ''); ?>" name="fees_type">
                                            <option data-display="<?php echo app('translator')->get('Type de frais'); ?> *" value=""><?php echo app('translator')->get('Type de frais'); ?> *</option>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                                    <input class="primary-input form-control<?php echo e($errors->has('amount') ? ' is-invalid' : ''); ?>"
                                                        ...
                                                        <label><?php echo app('translator')->get('Montant'); ?> <span>*</span></label>
                                                    <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('Liste de frais'); ?></h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <thead>
                                ...
                                <?php endif; ?>
                                <tr>
                                    <th><?php echo app('translator')->get('catégorie de frais'); ?></th>
                                    <th><?php echo app('translator')->get('type de frais'); ?></th>
                                                ...
                                                <div class="dropdown mb-20">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                       <?php if(in_array(120, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(url('fees-master', [$fees_master->id])); ?>"><?php echo app('translator')->get('Modifier'); ?></a>
                                                       <?php endif; ?>
                                                        ...
                                                        <a class="dropdown-item deleteFeesMasterSingle" data-toggle="modal" data-target="#deleteFeesMasterSingle"
                                                            href="#" data-id="<?php echo e($fees_master->id); ?>"><?php echo app('translator')->get('Supprimer'); ?></a>
                                                   <?php endif; ?>
                                                        </div>
                                                </div>
                                    ...
                                    <td valign="top">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('fees_assign', [$fees_master->fees_group_id])); ?>" ><?php echo app('translator')->get('Attribuer à une classe'); ?>/<?php echo app('translator')->get('Voir'); ?></a>
                                                <?php endif; ?>
                                                <a class="dropdown-item deleteFeesMasterGroup" data-toggle="modal" href="#" data-id="<?php echo e($fees_master->fees_group_id); ?>" data-target="#deleteFeesMasterGroup"><?php echo app('translator')->get('supprimer'); ?></a>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/feesCollection/fees_master.blade.php ENDPATH**/ ?>