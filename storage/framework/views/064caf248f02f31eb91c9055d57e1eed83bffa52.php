                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <?php if(!empty($getPayrollDetails)): ?>
                               ...
                               <?php if($getPayrollDetails->payroll_status == 'P'): ?>
                                ...
                                <?php endif; ?>
                                <?php else: ?>
                                <button class="primary-btn small bg-danger text-white border-0"><?php echo app('translator')->get('lang.not'); ?> <?php echo app('translator')->get('lang.generated'); ?></button>
                        ...
                        <?php if(!empty($getPayrollDetails)): ?>
                          ...
                          <?php if(in_array(176, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                            ...
                            <a class="modalLink" data-modal-size="modal-lg" title="Proceed to pay" href="<?php echo e(url('pay-payroll/'.$getPayrollDetails->id.'/'.$value->role_id)); ?>"><button class="primary-btn small tr-bg"><?php echo app('translator')->get('lang.proceed_to_pay'); ?></button></a>
                            <?php endif; ?>
                        ...
                        <?php endif; ?>
                            ...
                            <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="<?php echo e(url('view-payslip', $getPayrollDetails->id)); ?>"><button class="primary-btn small tr-bg"><?php echo app('translator')->get('lang.view_payslip'); ?></button></a>
                            <?php endif; ?>
                        <?php endif; ?>
                            ...
                            <a class="" href="<?php echo e(url('generate-Payroll/'.$value->id.'/'.$payroll_month.'/'.$payroll_year)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->get('lang.generate_payroll'); ?></button></a>
                            <?php endif; ?>
                        <?php endif; ?>
                        </td>
                    </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/payroll/index.blade.php ENDPATH**/ ?>