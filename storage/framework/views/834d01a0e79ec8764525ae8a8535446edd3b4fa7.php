...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                <a href="<?php echo e(url('staff-attendance-import')); ?>" class="primary-btn small fix-gr-bg pull-right sm_mb_20 sm2_mb_20"><span class="ti-plus pr-2"></span>Import Attendance</a>
            </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <?php endif; ?>
                    <div class="white-box">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'staff-attendance-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'infix_form'])); ?>
...
<?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
            ...
            <div class="row mt-40">
                <div class="col-lg-12">
                    ...
                    <?php if(in_array(166, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/staff_attendance.blade.php ENDPATH**/ ?>