...
<div class="col-lg-9 staff-details">
    ...
    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#staffDocuments" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.documents'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#staffTimeline" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.timeline'); ?></a>
        </li>
        <li class="nav-item edit-button">
            <a href="<?php echo e(url('edit-staff/'.$staffDetails->id)); ?>" class="primary-btn small fix-gr-bg"><?php echo app('translator')->get('lang.edit'); ?>
            </a>
        </li>
    </ul>
    ...
    <div class="white-box">
        ...
        <thead>
            <tr>
                ...
                <th width="15%"><?php echo app('translator')->get('lang.net_salary'); ?>(<?php echo e($currency); ?>)</th>
...
<?php echo e($value->created_at != ""? App\SmGeneralSettings::DateConvater($value->created_at):''); ?>
                ...
                <td>
                    <?php if($value->payroll_status == 'P'): ?>
                    <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="<?php echo e(url('view-payslip', $value->id)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->get('lang.view'); ?> <?php echo app('translator')->get('lang.payslip'); ?></button></a>
                    <?php endif; ?>
                </td>
            </tr>
...
<?php echo e($value->apply_date != ""? App\SmGeneralSettings::DateConvater($value->apply_date):''); ?>
                        ...
                        <td>
                            <a class="modalLink" data-modal-size="modal-md" title="View Leave Details" href="<?php echo e(url('view-leave-details', $value->id)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->get('lang.view'); ?> </button></a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/viewStaff.blade.php ENDPATH**/ ?>