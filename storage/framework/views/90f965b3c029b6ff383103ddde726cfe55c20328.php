...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('Affecter une matière'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('Tableau de bord'); ?></a>
                <a href="#"><?php echo app('translator')->get('Gestion academique'); ?></a>
                <a href="<?php echo e(route('assign_subject')); ?>"><?php echo app('translator')->get('Affecter une matière'); ?></a>
                <a href="<?php echo e(route('assign_subject_create')); ?>"><?php echo app('translator')->get('Affecter une matière'); ?></a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md">
                                <select class="w-100 bb niceSelect form-control <?php echo e(@$errors->has('class') ? ' is-invalid' : ''); ?>" id="select_class" name="class">
                                    <option data-display="<?php echo app('translator')->get('Sélectionner la classe'); ?>*" value=""><?php echo app('translator')->get('Sélectionner la classe'); ?>*</option>
                            ...
                            <div class="col-lg-6 mt-30-md" id="select_section_div">
                                <select class="w-100 bb niceSelect form-control<?php echo e(@$errors->has('section') ? ' is-invalid' : ''); ?>" id="select_section" name="section">
                                    <option data-display="<?php echo app('translator')->get('Sélectionnez le niveau '); ?> *" value=""><?php echo app('translator')->get('Sélectionnez le niveau'); ?> *</option>
                                </select>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('Affecter une matières à un Enseignants'); ?> </h3>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control subject" name="subjects[]">
                                                    <option data-display="<?php echo app('translator')->get('Sélectionner la matière'); ?>" value=""><?php echo app('translator')->get('Sélectionner la matière'); ?></option>
                                            ...
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control" name="teachers[]">
                                                    <option data-display="<?php echo app('translator')->get('Sélectionner l\'Enseignants'); ?>" value=""><?php echo app('translator')->get('Sélectionner l\'Enseignants'); ?></option>
...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('Affecter une matière'); ?> </h3>
                </div>
            </div>
            <div class="col-lg-6 text-right">
                <button class="primary-btn icon-only fix-gr-bg" type="button">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control" name="subjects[]" id="subjects">
                                                    <option data-display="<?php echo app('translator')->get('Sélectionnez la matière'); ?>" value=""><?php echo app('translator')->get('Sélectionner la matière'); ?></option>
                                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control" name="teachers[]">
                                                    <option data-display="<?php echo app('translator')->get('Sélectionnez l\enseignant'); ?>" value=""><?php echo app('translator')->get('Sélectionnez l\enseignant'); ?></option>
                                                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/academics/assign_subject_create.blade.php ENDPATH**/ ?>