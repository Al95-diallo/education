...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        <?php if(isset($editData)): ?>
            <?php if(in_array(441, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
            <div class="row">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            type="text" name="holiday_title" autocomplete="off" value="<?php echo e(isset($editData)? $editData->holiday_title : ''); ?>">
                                ...
                                <div class="row mb-20">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <textarea class="primary-input form-control <?php echo e($errors->has('details') ? ' is-invalid' : ''); ?>" cols="0" rows="4" name="details"><?php echo e(isset($editData)? $editData->details: ''); ?></textarea>
                                ...
                                <div class="row no-gutters input-right-icon mb-30">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            placeholder="<?php echo e(isset($editData->upload_image_file) && $editData->upload_image_file != ""? showPicName($editData->upload_image_file):'Attach File'); ?>"
                                    ...
                                    <div class="col-auto">
                                        <button class="primary-btn-small-input" type="button">
                                            <label class="primary-btn small fix-gr-bg" for="upload_holiday_image"><?php echo app('translator')->get('lang.browse'); ?></label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  data-sort="<?php echo e(strtotime($value->from_date)); ?>" >
                                <?php echo e($value->from_date != ""? App\SmGeneralSettings::DateConvater($value->from_date):''); ?>


                            </td>
                            <td  data-sort="<?php echo e(strtotime($value->to_date)); ?>" >
                               <?php echo e($value->to_date != ""? App\SmGeneralSettings::DateConvater($value->to_date):''); ?>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <?php if(in_array(442, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            <a class="dropdown-item" href="<?php echo e(url('holiday/'.$value->id.'/edit')); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                        <?php endif; ?>
                                        <?php if(in_array(443, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Holiday" href="<?php echo e(url('delete-holiday-view/'.$value->id)); ?>"><?php echo app('translator')->get('lang.delete'); ?></a>
                                        <?php endif; ?>
                                        <?php if($value->upload_image_file != ""): ?>
                                             <a class="dropdown-item" href="<?php echo e(url('download-holiday-document/'.showPicName($value->upload_image_file))); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/holidays/holidaysList.blade.php ENDPATH**/ ?>