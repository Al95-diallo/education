                                                        ...
                                                        <?php if(@$visitor->file != ""): ?>
                                                            <?php if(in_array(20, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>
                                                                <?php if(@file_exists($visitor->file)): ?>
                                                                        <a class="dropdown-item"
                                                                        href="<?php echo e(url('download-visitor-document/'.$visitor->id)); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/admin/visitor.blade.php ENDPATH**/ ?>