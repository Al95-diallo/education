...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('Rechercher des revenus/dépenses'); ?></h1>
            <div class="bc-pages">
...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        ...
        <?php if(isset($fees_dues)): ?>
             ...
             <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'send-dues-fees-email', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student'])); ?>
                            ...
                            <table id="table_id" class="display school-table " cellspacing="0" width="100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('lang.due_birth'); ?></th>
                                        <th><?php echo app('translator')->get('lang.amount'); ?> (<?php echo e($currency); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.deposit'); ?> (<?php echo e($currency); ?>)</th>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/feesCollection/search_fees_due.blade.php ENDPATH**/ ?>