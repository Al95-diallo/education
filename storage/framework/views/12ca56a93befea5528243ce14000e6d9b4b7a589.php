    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            <div class="row"> 
                <div class="col-lg-12">
                    <div class="white-box"> 
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'assign-optional-subject-store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'formid'])); ?>
                                        ...
                                        <table id="table_id1" class="display school-table" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo app('translator')->get('lang.optional'); ?> <?php echo app('translator')->get('lang.subject'); ?></th>   
                                                </tr>
                                            </thead>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/academics/assign_optional_subject.blade.php ENDPATH**/ ?>