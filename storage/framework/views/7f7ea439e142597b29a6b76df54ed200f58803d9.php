        ...
        <div class="row mt-25">
            <div class="col-lg-12" id="sibling_class_div">
                <div class="input-effect">
                    ...
                    <label><?php echo app('translator')->get('lang.staff_name'); ?> <span></span> </label>
        ...
        <div class="row mt-25">
            <div class="col-lg-6" id="">
                <div class="input-effect">
                    ...
                    <label><?php echo app('translator')->get('lang.month'); ?> <?php echo app('translator')->get('lang.year'); ?> <span></span> </label>
                    <span class="focus-border"></span>
                    <?php if($errors->has('amount')): ?>
                    <span class="invalid-feedback" role="alert">
                        <strong><?php echo e($errors->first('amount')); ?></strong>
            ...
            <div class="col-lg-6" id="">
                <div class="input-effect">
                    ...
                    <label><?php echo app('translator')->get('lang.payment'); ?> <?php echo app('translator')->get('lang.date'); ?> <span>*</span> </label>
                    <span class="focus-border"></span>
        ...
        <div class="row mt-25">
            <div class="col-lg-6">
                <div class="input-effect">
                    ...
                    <label><?php echo app('translator')->get('lang.payment'); ?> <?php echo app('translator')->get('lang.amount'); ?> <span>*</span> </label>
                    <span class="focus-border"></span>
            ...
            <div class="col-lg-6">
                <div class="input-effect">
                    ...
                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('payment_mode') ? ' is-invalid' : ''); ?>" name="payment_mode" id="payment_mode">
                        <option data-display="Payment Method *" value=""><?php echo app('translator')->get('lang.payment_method'); ?> *</option>
...
</div><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/humanResource/payroll/paymentPayroll.blade.php ENDPATH**/ ?>