<?php
    ...
    if(isset($setting->copyright_text)){ $copyright_text = $setting->copyright_text; }else{ $copyright_text = 'Copyright 2022 Tous droits réservés Cette application est faite par GN-TECH'; }
    ...
    <div class="modal-dialog modal-dialog-centered" id="modalSize">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="showDetaildModalTile"><?php echo app('translator')->get('information du nouveau client'); ?></h4>
...
<div class="modal fade invoice-details" id="showDetaildModalInvoice">
    <div class="modal-dialog large-modal modal-dialog-centered" >
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo app('translator')->get('Ajouter une facture d\'achat'); ?></h4>
...
<?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/partials/footer.blade.php ENDPATH**/ ?>