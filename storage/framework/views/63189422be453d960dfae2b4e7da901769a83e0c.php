        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-title">
                    <h3 class="mb-0"><?php echo app('translator')->get('Bienvenue'); ?> - <?php echo e(@Auth::user()->school->school_name); ?> | <?php echo e(@Auth::user()->roles->name); ?></h3>
            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3><?php echo app('translator')->get('Gestion des élèves'); ?></h3>
                            <p class="mb-0"><?php echo app('translator')->get('Total'); ?> <?php echo app('translator')->get('élèves'); ?></p>
                        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3><?php echo app('translator')->get('Enseignants'); ?></h3>
                            <p class="mb-0"><?php echo app('translator')->get('Total Enseignants'); ?></p>
                        </div>
                        <h1 class="gradient-color2">
                            <?php if(isset($totalStudents)): ?>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3><?php echo app('translator')->get('parents'); ?></h3>
                            <p class="mb-0"><?php echo app('translator')->get('Total parents'); ?></p>
                        </div>
                        <h1 class="gradient-color2">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3><?php echo app('translator')->get('Le personnel'); ?></h3>
                            <p class="mb-0"><?php echo app('translator')->get('Total personnel'); ?></p>
                        </div>
                        <h1 class="gradient-color2">
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-8 col-md-9 col-8">
                <div class="main-title">
                    <h3 class="mb-30"> <?php echo app('translator')->get('Revenus et dépenses pour'); ?> <?php echo e(date('M')); ?> <?php echo e($year); ?> </h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1><?php echo e(number_format($m_total_income)); ?><?php echo e($currency); ?></h1>
                                <p><?php echo app('translator')->get('lang.total_income'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1><?php echo e(number_format($m_total_expense)); ?><?php echo e($currency); ?></h1>
                                <p><?php echo app('translator')->get('Dépenses totales'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1><?php echo e(number_format($m_total_income - $m_total_expense)); ?><?php echo e($currency); ?></h1>
                        ...
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1><?php echo e(number_format($m_total_income)); ?><?php echo e($currency); ?></h1>
                                <p><?php echo app('translator')->get('Revenu total'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-12">
...
<section class="mt-50" id="incomeExpenseSessionDiv">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-8 col-md-9 col-8">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('Revenus et dépenses pour'); ?> <?php echo e($year); ?></h3>
                </div>
            </div>
            <div class="offset-lg-2 col-lg-2 text-right col-md-3 col-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                ...
                                <p><?php echo app('translator')->get('Bénéfice total'); ?></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
...
<section class="mt-50">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-10">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('Tableau daffichage'); ?></h3>
                </div>
            </div>
            <div class="col-lg-2 pull-right text-right">
                <a href="<?php echo e(url('add-notice')); ?>" class="primary-btn small fix-gr-bg"> <span class="ti-plus pr-2"></span> <?php echo app('translator')->get('Ajouter'); ?> </a>
            </div>
                ...
                <table class="school-table-style w-100">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('Titre'); ?></th>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            ...
                            <h3 class="mb-30"><?php echo app('translator')->get('Calendrier'); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-lg-5 col-xl-4 mt-50-md md_infix_50">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6">
                        <div class="main-title">
                            <h3 class="mb-30"><?php echo app('translator')->get('Liste de choses à faire'); ?></h3>
                        </div>
                    </div>
                                                ...
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            ...
                                                            <label><?php echo app('translator')->get('date'); ?> <span></span> </label>
                    ...
                    <div class="white-box school-table">
                        <div class="row to-do-list mb-20">
                            <div class="col-md-6 col-6">
                                <button class="primary-btn small fix-gr-bg" id="toDoList"><?php echo app('translator')->get('Incomplet'); ?></button>
                            </div>
                            <div class="col-md-6 col-6">
                                <button class="primary-btn small tr-bg" id="toDoListsCompleted"><?php echo app('translator')->get('Terminer'); ?></button>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">fermer</button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InfixEdu_v5\resources\views/backEnd/dashboard.blade.php ENDPATH**/ ?>