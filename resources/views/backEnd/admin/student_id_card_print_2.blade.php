                ...
                <div class="id_card" id="id_card" style="display: grid !important;grid-template-columns: repeat(3,1fr) !important;grid-gap: 20px;justify-content: center;">
                    @foreach($students as $student)
    			     <table cellpadding="0" cellspacing="0" border="0" width="156" height="241" align="center" style=" border: 1px solid #ddd; margin: 0px 0 0 0;" >
                        <tr style="border-right: 1px solid #ddd; border-left: 1px solid #ddd;  height: 0px; ">
                            <td colspan="3" style=" position: relative; text-align: center; background-color: #c738d8; border:1px solid #c738d8">
                               <!--  <center>
                                ...
                                <h3 style="padding: 5px; text-align: center; margin-bottom: 0px; font-size: 12px;  color: #fff; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; ">@lang('carte scolaire')</h3>
                            </td>
                        </tr>
                        <tr >
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('nom_élève')</td>
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('Matricule')</td>
                        ...
                        @if(@$id_card->class == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd;">@lang('classe')</td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('nom du père')</td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('nom_mère')</td>                            
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('Adresse')</td>                           
                        ...
                        @if(@$id_card->blood == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('groupe sanguin')</td>                           
                        ...
                        @if(@$id_card->phone == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('téléphone')</td>
                        ...
                        @if(@$id_card->dob == 1)
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">@lang('Date_naissance')</td>                            
