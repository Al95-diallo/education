...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Gérer les certificats de formations')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('tableau de bord')</a>
                <a href="#">@lang('Gérer les certificats')</a>
                <a href="#">@lang('Générer les certificats de formations')</a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="add-visitor">
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('nom_certificate')<span>*</span></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('En-tête gauche du texte') <span></span></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12 d-flex">
                                        <p class="text-uppercase fw-500 mb-10">@lang('photo_élève')</p>
                                        <div class="d-flex radio-btn-flex ml-40">
                                            <div class="mr-30">
                                                ...
                                                <label for="relationFather">@lang('Oui')</label>
                                            </div>
                                            <div class="mr-30">
                                                ...
                                                <label for="relationMother">@lang('non')</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    ...
                                    <div class="col-auto">
                                        <button class="primary-btn-small-input" type="button">
                                            <label class="primary-btn small fix-gr-bg" for="browseFile">@lang('feuilleter')</label>
            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">  @lang('liste de certificats')</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" data-toggle="modal" data-target="#showCertificateModal{{ @$certificate->id}}"  href="#">@lang('voir')</a>
                                                 @if(in_array(51, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1)
                                                <a class="dropdown-item" href="{{url('student-certificate/'.@$certificate->id.'/edit')}}">modifier</a>
                                                @endif
                                                 @if(in_array(52, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1)
                                                <a class="dropdown-item" data-toggle="modal" data-target="#deleteSectionModal{{ @$certificate->id}}"  href="#">@lang('supprimer')</a>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('supprimer un certificats')</h4>
                                ...
                                <div class="modal fade admin-query" id="showCertificateModal{{ @$certificate->id}}">
                                    <div class="modal-dialog modal-dialog-centered large-modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('voir le certificat')</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                                            ...
                                                            <div>
                                                                <div class="row justify-content-lg-between mb-5">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <p class="m-0">@lang('date'): {{ @$certificate->date }}</p>
                                                                    </div>
                                                                </div>
