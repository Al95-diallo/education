                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                            <label>@lang('selectionnez la classe')</label>
                                            @php $h = 0; @endphp
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                            <label>@lang('Selectionnez le niveau')</label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                            <label>@lang('Selectionnez la matière')</label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="w-100 bb niceSelect form-control {{ $errors->has('class') ? ' is-invalid' : '' }}" id="select_class" name="class">
                                            <option data-display="@lang('selctionnez la classe') *" value="">@lang('selctionnez la classe') *</option>
                                            @foreach($classes as $class)
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12 mt-30-md" id="select_section_div">
                                        <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_section" id="select_section" name="section"  readonly="">
                                            <option data-display="@lang('selctionnez le niveau') *" value="">@lang('selctionnez le niveau') *</option>
                                            @if(isset($exam))
                                                @foreach($sections as $section)
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12" id="select_subject_div">
                                        <select class="w-100 bb niceSelect form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" id="select_subject" name="subject"  readonly="">
                                            <option data-display="@lang('selctionnez la matière') *" value="">@lang('selctionnez la matière') *</option>
                                            @if(isset($exam))
                                                @foreach($subjects as $subject)
                      ...
                      <tr id="row1" class="0">
                            ...
                            <input type="hidden" name="url" id="url" value="{{URL::to('/')}}">  
                                <div class="input-effect">
                                    ...
                                    type="text" id="exam_title" name="exam_title[]" autocomplete="off" value="{{isset($editData)? $editData->exam_title : '' }}" placeholder="@lang('nom_examen')">
                        ...
                        <tfoot>
                            <tr>
                               <th class="border-top-0">@lang('total')</th>
