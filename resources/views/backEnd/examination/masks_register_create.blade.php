        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">Sélectionner des critères </h3>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mt-30-md">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="exam">
                                    <option data-display="Select Exam *" value="">Selectionnez Examen *</option>
                            ...
                            <div class="col-lg-3 mt-30-md" id="select_section_div">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_section" id="select_section" name="section">
                                    <option data-display="@lang('sélectionnez la niveau') *" value=" ">@lang('sélectionnez la niveau') *</option>
                                </select>
                            ...
                            <div class="col-lg-3 mt-30-md" id="select_subject_div">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('subject') ? ' is-invalid' : '' }} select_subject" id="select_subject" name="subject">
                                    <option data-display="sélectionnez la matière *" value="">sélectionnez la matière *</option>
                                </select>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">Feuilles de notes</h3>
                </div>
            </div>
        </div>
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" >Nom_élèves</th>
                            <th colspan="{{$number_of_exam_parts + 1}}"> {{$subjectNames->subject_name}}</th> 
                            <th rowspan="2">est il present lors de l'examen</th>
                        </tr>
                        <tr>
                            ...
                            @endforeach
                            <th>@lang('Observation du professeur')</th>
                        </tr>
                    </thead>
                    <tbody>                        
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    ...
                                    <label>{{$part->exam_title}} Notes</label>
                            ...
                            <td>
                                <div class="input-effect">
                                    ...
                                    <button class="primary-btn small fix-gr-bg" type="button">@lang('présent')</button>
                                    @else
                                    <button class="primary-btn small bg-danger text-white border-0" type="button">@lang('Absent')</button>
                                    @endif
                                    ...
                                    <label for="subject_{{$student->id}}_{{$student->admission_no}}">Oui</label> --}}
