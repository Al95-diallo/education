...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Envoyer des Notes par sms') </h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('Tableau de bord')</a>
                <a href="#">@lang('examens')</a>
                <a href="#">@lang('Envoyer des Notes par sms')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('Envoyer des Notes par sms')</h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                            <div class="col-lg-4 mt-30-md">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="exam">
                                    <option data-display="@lang('lang.select_exam') *" value="">@lang('Selectionnez l\'examen')*</option>
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <select class="w-100 bb niceSelect form-control {{ $errors->has('class') ? ' is-invalid' : '' }}" id="select_class" name="class">
                                    <option data-display="@lang('lang.select_class') *" value="">@lang('Selectionnez la classe') *</option>
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <select class="w-100 bb niceSelect form-control {{ $errors->has('receiver') ? ' is-invalid' : '' }}" name="receiver">
                                    <option data-display="@lang('Selectionnez le destinataire') *" value="">@lang('Selectionnez le destinataire') *</option>
                                    
                                    <option value="students"  {{( old('receiver') == 'students' ? "selected":"")}}>@lang('élèves')</option>
                                    <option value="parents"  {{( old('receiver') == 'parents' ? "selected":"")}}>@lang('parents')</option>
                            ...
                            <div class="col-lg-12 mt-40 text-center">
                               <button class="primary-btn fix-gr-bg" data-toggle="tooltip" title="{{$tooltip}}">
                                    ...
                                    @lang('Envoyer des Notes par sms')
                                </button>
                            </div>
                        </div>
                    {{ Form::close() }}
