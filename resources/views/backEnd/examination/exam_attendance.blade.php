            ...
            <div class="row mb-20">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="main-title sm_mb_20">
                        <h3 class="mb-0">@lang('Sélectionner des critères') </h3>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30">@lang('Présence à l\'examen')</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(@$student->attendance_type == 'P')
                                             <button class="primary-btn small bg-success text-white border-0">@lang('présent')</button>
                                             @else
                                             <button class="primary-btn small bg-danger text-white border-0">@lang('Absent')</button>
                                             @endif
                                        </td>
                                    </tr>
                                    @endforeach
