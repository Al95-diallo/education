    ...
    <div class="container-fluid p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mt-30-md">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="exam">
                                    <option data-display="@lang('lang.select_exam') *" value="">@lang('Selectionnez un examen') *</option>
                            ...
                            <div class="col-lg-3 mt-30-md" id="select_section_div">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_section" id="select_section" name="section">
                                    <option data-display="@lang('Selectionnez le Niveaux') *" value="">@lang('Selectionnez le Niveaux') *</option>
                                </select>
        ...
        <div class="row mt-40">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-0">@lang('Ajouter des notes')</h3>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <table class="display school-table school-table-style" cellspacing="0" width="100%" >
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" >@lang('Matricule').</th>
                            <th rowspan="2" >@lang('Nom_élèves')</th>
                            <th colspan="{{@$number_of_exam_parts}}"> {{@$subjectNames->subject_name}}</th> 
                            <th rowspan="2">@lang('est il present lors de l\'examen')</th>
                        </tr>
                        <tr>
                ...
                <table id="" class="school-table-data school-table shadow-none" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('pourcentage')(%)</th>
                            <th>@lang('resultats obtenue')</th>
