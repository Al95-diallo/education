...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Affecter une matière')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('Tableau de bord')</a>
                <a href="#">@lang('Gestion academique')</a>
                <a href="{{route('assign_subject')}}">@lang('Affecter une matière')</a>
                <a href="{{route('assign_subject_create')}}">@lang('Affecter une matière')</a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md">
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('class') ? ' is-invalid' : '' }}" id="select_class" name="class">
                                    <option data-display="@lang('Sélectionner la classe')*" value="">@lang('Sélectionner la classe')*</option>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('Affecter une matières à un Enseignants') </h3>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control subject" name="subjects[]">
                                                    <option data-display="@lang('Sélectionner la matière')" value="">@lang('Sélectionner la matière')</option>
                                            ...
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control" name="teachers[]">
                                                    <option data-display="@lang('Sélectionner l\'Enseignants')" value="">@lang('Sélectionner l\'Enseignants')</option>
...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('Affecter une matière') </h3>
                </div>
            </div>
            <div class="col-lg-6 text-right">
                <button class="primary-btn icon-only fix-gr-bg" type="button">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control" name="subjects[]" id="subjects">
                                                    <option data-display="@lang('Sélectionnez la matière')" value="">@lang('Sélectionner la matière')</option>
                                                    @foreach($subjects as $subject)
                                            ...
                                            <div class="col-lg-5 mt-30-md">
                                                <select class="w-100 bb niceSelect form-control" name="teachers[]">
                                                    <option data-display="@lang('Sélectionnez l\enseignant')" value="">@lang('Sélectionnez l\enseignant')</option>
                                                    @foreach($teachers as $teacher)
