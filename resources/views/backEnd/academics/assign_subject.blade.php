...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Affecter une matière à un Enseignants')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('gestion de matières')</a>
                <a href="#">@lang('Affecter une matière à un Enseignants')</a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md">
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('class') ? ' is-invalid' : '' }}" id="select_class" name="class">
                                    <option data-display="@lang('lang.select_class')*" value="">@lang('Sélectionner la classe') *</option>
                            ...
                            <div class="col-lg-6 mt-30-md" id="select_section_div">
                                <select class="w-100 bb niceSelect form-control{{ @$errors->has('section') ? ' is-invalid' : '' }}" id="select_section" name="section">
                                    <option data-display="@lang('selectionnez le niveau') *" value="">@lang('Sélectionner le niveau')*</option>
                                </select>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-0">@lang('Liste de professeur par matières/classe') </h3>
                </div>
            </div>
        </div>
        <div class="row">
