...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Gestion de matières')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('Tableau de bord')</a>
                <a href="#">@lang('Académique')</a>
                <a href="#">@lang('Ajouter une matière')</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('Nom_matière') <span>*</span></label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex radio-btn-flex">
                                            ...
                                            <div class="mr-30">
                                                ...
                                                <label for="relationFather">@lang('Théorie')</label>
                                            </div>
                                            <div class="mr-30">
                                                ...
                                                <label for="relationMother">@lang('Pratique')</label>
                                            </div>
                                            @else
                                            <div class="mr-30">
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('Code_matière') <span>*</span></label>
                                            <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('Liste des matières')</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <thead>
                               @if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    <!-- <th> @lang('sl')</th> -->
                                    <th> @lang('matières')</th>
                                    <th> @lang('type_matières')</th>
                                    <th>@lang('Code_matières')</th>
                                    <th>@lang('action')</th>
                                </tr>
                            </thead>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('Supprimer une matière')</h4>
