...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Gestion d\'emplois du temps Scolaire')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('Tableau de bord')</a>
                <a href="#">@lang('emplois du temps')</a>
                <a href="#">@lang('emplois du temps Scolaire')</a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-30-md" id="select_section_div">
                                    <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }}" id="select_section" name="section">
                                        <option data-display="@lang('Selectionnez la section') *" value="">@lang('Selectionnez le niveau') *</option>
                                    </select>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-6 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30">@lang('Emplois du temps Scolaire')</h3>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-lg-6 text-right">
                                    <a href="{{url('add-new-routine', [$class_time->id, $sm_weekend->id, $class_id, $section_id])}}" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="@lang('Ajouter un emplois du temps')">
