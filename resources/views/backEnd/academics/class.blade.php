                            ...
                            <div class="add-visitor">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('Nom_classe') <span>*</span></label>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12 text-center">
                                        <button class="primary-btn small fix-gr-bg" data-toggle="tooltip" title="{{$tooltip}}">
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('Liste de Classe')</h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('class_edit', [@$class->id])}}">@lang('Modifier')</a>
                                               @endif
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('Supprimer une classe')</h4>
