        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-title">
                    <h3 class="mb-0">@lang('Bienvenue') - {{@Auth::user()->school->school_name}} | {{@Auth::user()->roles->name}}</h3>
            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3>@lang('Gestion des élèves')</h3>
                            <p class="mb-0">@lang('Total') @lang('élèves')</p>
                        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3>@lang('Enseignants')</h3>
                            <p class="mb-0">@lang('Total Enseignants')</p>
                        </div>
                        <h1 class="gradient-color2">
                            @if(isset($totalStudents))
                            {{count($totalTeachers)}}
            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3>@lang('parents')</h3>
                            <p class="mb-0">@lang('Total parents')</p>
                        </div>
                        <h1 class="gradient-color2">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3>@lang('Le personnel')</h3>
                            <p class="mb-0">@lang('Total personnel')</p>
                        </div>
                        <h1 class="gradient-color2">
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-8 col-md-9 col-8">
                <div class="main-title">
                    <h3 class="mb-30"> @lang('Revenus et dépenses pour') {{date('M')}} {{ $year }} </h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1>{{number_format($m_total_income)}}{{$currency}}</h1>
                                <p>@lang('lang.total_income')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1>{{number_format($m_total_expense)}}{{$currency}}</h1>
                                <p>@lang('Dépenses totales')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="text-center">
                                <h1>{{number_format($m_total_income - $m_total_expense)}}{{$currency}}</h1>
...
<section class="mt-50" id="incomeExpenseSessionDiv">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-8 col-md-9 col-8">
                <div class="main-title">
                    <h3 class="mb-30">@lang('Revenus et dépenses pour') {{ $year }}</h3>
                </div>
            </div>
            <div class="offset-lg-2 col-lg-2 text-right col-md-3 col-4">
...
<section class="mt-50">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-10">
                <div class="main-title">
                    <h3 class="mb-30">@lang('Tableau daffichage')</h3>
                </div>
            </div>
            <div class="col-lg-2 pull-right text-right">
                <a href="{{url('add-notice')}}" class="primary-btn small fix-gr-bg"> <span class="ti-plus pr-2"></span> @lang('Ajouter') </a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            ...
                            <h3 class="mb-30">@lang('Calendrier')</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-lg-5 col-xl-4 mt-50-md md_infix_50">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('Liste de choses à faire')</h3>
                        </div>
                    </div>
                    ...
                    <div class="white-box school-table">
                        <div class="row to-do-list mb-20">
                            <div class="col-md-6 col-6">
                                <button class="primary-btn small fix-gr-bg" id="toDoList">@lang('Incomplet')</button>
                            </div>
                            <div class="col-md-6 col-6">
                                <button class="primary-btn small tr-bg" id="toDoListsCompleted">@lang('Terminer')</button>
                            </div>
                        </div>
