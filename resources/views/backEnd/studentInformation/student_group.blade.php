...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Gestion de groupe des élève')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('tableau de bord')</a>
                <a href="#">@lang('informations de l\'élèves')</a>
                <a href="#">@lang('groupe des élèves')</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('groupe') <span>*</span></label>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('liste des groupe')</h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('student_group_edit', [$student_group->id])}}">@lang('Modifier')</a>
                                               @endif
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('supprimer le groupe')</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    ...
                                                    <a href="{{route('student_group_delete', [$student_group->id])}}"><button class="primary-btn fix-gr-bg" type="submit">@lang('Supprimer')</button></a>
                                                </div>
                                            </div>
