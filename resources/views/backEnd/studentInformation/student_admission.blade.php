...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('Gestion des élèves')</h1>
            <div class="bc-pages">
                <a href="{{url('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('Inscription d’un élèves')</a>
                <a href="#">@lang('Gestion des élèves')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6">
                <div class="main-title xs_mt_0 mt_0_sm">
                    <h3 class="mb-0">@lang('Ajouter les informations d’un nouvel') @lang('élève')</h3>
                </div>
            </div>
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="main-title">
                                    <h4 class="stu-sub-head">@lang('Les informations personnelles de') @lang('l’élève')</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20" id="sectionStudentDiv">
                                    <select class="niceSelect w-100 bb form-control {{ $errors->has('section') ? ' is-invalid' : '' }}" name="section"
                                       ...
                                       <option data-display="@lang('Niveaux') *" value="">@lang('Niveaux') *</option>
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                   ...
                                   <label>@lang('code national d’élève')</label>
                                    <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender">
                                        <option data-display="@lang('lang.gender') *" value="">@lang('Sexe') *</option>
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <label>@lang('Taille')<span></span> </label>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderPhoto" placeholder="@lang('Photo')"
                                                readonly="">
                                            <span class="focus-border"></span>
                                    ...
                                    <div class="col-auto">
                                        <button class="primary-btn-small-input" type="button">
                                            <label class="primary-btn small fix-gr-bg" for="photo">@lang('Télécharger')</label>
                        ...
                        <div class="parent_details" id="parent_details">
                            ...
                            <div class="row mt-40">
                                <div class="col-lg-12">
                                    <div class="main-title">
                                        <h4 class="stu-sub-head">@lang('Détails du parent tuteur') </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-40 mt-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Nom du père')<span></span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Occupation du père')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                 <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Téléphone du père') <span></span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg" for="fathers_photo">@lang('Télécharger')</label>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Nom de la mère') <span></span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Occupation maternelle')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                 <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Téléphone de la mère')<span></span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg" for="mothers_photo">@lang('Télécharger')</label>
                            ...
                            <div class="row mb-40">
                                <div class="col-lg-12 d-flex">
                                    <p class="text-uppercase fw-500 mb-10">@lang('Si le gardien est')</p>
                                    <div class="d-flex radio-btn-flex ml-40">
                                        <div class="mr-30">
                                            ...
                                            <label for="relationFather">@lang('père')</label>
                                        </div>
                                        <div class="mr-30">
                                            ...
                                            <label for="relationMother">@lang('mère')</label>
                                        </div>
                                        <div>
                                            ...
                                            <label for="relationOther">@lang('Autre')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-40">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Nom du gardien ')<span></span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Relation de gardien') </label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('email du gardien')<span>*</span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg" for="guardians_photo">@lang('Télécharger')</label>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Téléphone du gardien') <span>*</span> </label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Occupation de gardien')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-40 mt-40">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('Adresse du gardien') @lang('lang.address') <span></span> </label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="main-title">
                                    <h4 class="stu-sub-head">@lang('élèves') @lang('lang.address') @lang('lang.info')</h4>
                                </div>
                            </div>
                        </div>
