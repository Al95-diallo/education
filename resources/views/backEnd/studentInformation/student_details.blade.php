    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"> @lang('Information sur les élèves')</a>
                <a href="#">@lang('Liste des élèves')</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3" id="sectionStudentDiv">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('section') ? ' is-invalid' : '' }}" id="sectionSelectStudent" name="section">
                                    <option data-display="@lang('le niveaux')" value="">@lang('le niveaux')</option>
                                </select>
                        ...
                        <div class="col-lg-2">
                            <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                                ...
                                <label>@lang('Rechercher par nom')</label>
                                <span class="focus-border"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                                ...
                                <label>@lang('Rechercher par matricule')</label>
                                <span class="focus-border"></span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0">@lang('Liste de élèves') ({{@$students ? @$students->count() : 0}})</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row  ">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    {{-- <a class="dropdown-item" href="{{url('previous-class-results-view', [$student->admission_no])}}">@lang('Resultats')</a> --}}
                                                    

                                                    <a class="dropdown-item" href="{{route('student_view', [$student->id])}}">@lang('voir')</a>

                                                {{-- @if(in_array(66, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                 <a class="dropdown-item" href="{{route('student_edit', [$student->id])}}">@lang('modifier')</a>
                                                @endif
                                                 @if(in_array(67, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
                                                  <a class="dropdown-item deleteStudentModal" href="#" data-toggle="modal" data-target="#deleteStudentModal" data-id="{{$student->id}}" onclick="deleteId()">@lang('supprimer')</a> --}}
                                                ...
                                                @endif
                                                 ...
                                                 <span  data-toggle="tooltip" title="Disabled For Demo "> 
                                                    <a  class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteStudentModal" data-id=""  >@lang('Désactiver')</a>
                                               
                                                     </span>
                                                     
                                                 @else
                                                 <a onclick="deleteId({{$student->id}});" class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteStudentModal" data-id="{{$student->id}}"  >@lang('Désactiver')</a>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('Désactiver un élèves')</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <h4>@lang('este-vous sur de vouloir Désactiver cet élève')</h4>
                    </div>
                    ...
                    <input type="hidden" name="id" value="{{@$student->id}}" id="student_delete_i">  {{-- using js in main.js --}}
                            <button class="primary-btn fix-gr-bg" type="submit">@lang('Désactiver')</button>
                        {{ Form::close() }}
                    </div>
